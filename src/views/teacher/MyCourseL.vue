...
<template>
    ...
    <el-card class="main-card">
        ...
        <el-table :data="bindData.myCourse" border stripe size="large">
            ...
            <el-table-column label="操作">
                ...
                <template v-slot:="scope">
                    <el-button type="primary" size="large" @click="onDetail(scope.row.cid)">详情</el-button>
        ...
        <div class="pagination">
            ...
            <el-pagination @current-change="handlehCurrentChange" :page-size="bindData.pageSize"
                :current-page="bindData.pageNum" layout="prev, pager, next" :total="bindData.totalNum" size="large" />
        </div>
